...
import calculatePrincipalBasedOnAccured from "../../utils/calculate-principal-based-on-accrued";
...
export const PrincipalBasedOnAccrued: FC = () => {
  ...
  const onSubmit = handleSubmit((values) => {
    console.log(values);
    const amount = calculatePrincipalBasedOnAccured({
  ...
  return (
    <div className="flex flex-col gap-4 rounded border-2 p-8">
      <h2 className="text-lg font-bold">
        Calculate Princial based on Accrued Amount{" "}
      </h2>
